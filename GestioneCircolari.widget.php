...
class CircolariWidget extends WP_Widget
{
	...
	{
	   parent::WP_Widget("circolari", 'Circolari', array('description' => 'Utilizzare questo widget per evidenziare lato pubblico del sito le circolari che l\'utente deve firmare',array( 'width' => 300, 'height' => 350)));
	 }
...
function circolariG_Widget_register()
{
    register_widget( 'CircolariWidget' );
}

add_action( 'widgets_init', 'circolariG_Widget_register' );
