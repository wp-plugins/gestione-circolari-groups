...
(function($) {
	$(function() {		 
		...
		$( "#DataScadenza" ).datepicker({ minDate: new Date($("#aa").attr('value'),$("#mm").attr('value')-1,$("#jj").attr('value')), dateFormat: 'dd/mm/yy' });
          	var l = window.location;
			var url = l.protocol + "//" + l.host +"/"+  l.pathname.split('/')[1]+"/wp-content/plugins/gestione-circolari-groups/swf/copy_csv_xls_pdf.swf";
